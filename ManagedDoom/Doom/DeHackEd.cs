...
{
	private static Tuple<Action<World.World, Player, PlayerSpriteDef>, Action<World.World, Mobj>>[] sourcePointerTable;
	...
	private static void ProcessLines(IEnumerable<string> lines)
	{
		...
		{
			sourcePointerTable = new Tuple<Action<World.World, Player, PlayerSpriteDef>, Action<World.World, Mobj>>[DoomInfo.States.Length];
